    ...
    mock: {
      ...
      endpoints: {
        ...
        dataset: {
          ...
          checkRatio: `/ratio/{dataset_id}/{columnOne}/{columnTwo}`,
          checkMatrix: `/matrix/{dataset_id}`,
          checkError: `/error/{dataset_id}/{columnOne}/{columnTwo}`,
        },
      },
    },
    flask: {
      ...
      endpoints: {
        ...
        dataset: {
          ...
          checkRatio: `/eda/ratio?id={dataset_id}&column_1={columnOne}&column_2={columnTwo}`,
          checkMatrix: `/eda/pairPlot?id={dataset_id}`,
          checkError: `/eda/error?id={dataset_id}&column_1={columnOne}&column_2={columnTwo}`,
        },
      },
    },
  },
